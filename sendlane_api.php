...
*/
	        ...
	        // TO GET THE LISTS INTO THE DROPDOWN...
	               			...
	               			$integrations_api_key = "*****************";   // you will get this key when account created on sendlane
	               			$integrations_hash_key = "************************************"; // you will get this key when account created on sendlane

	               			
		                    $ch = curl_init();

							curl_setopt($ch, CURLOPT_URL,            "https://yourwebsitename.sendlane.com/api/v1/lists" ); 
							/*
        ...
        // TO ADD THE SUBSCRIBER TO THE LIST.......
						...
						$integrations_api_key    = "***********************"; # put your credentials here
						$integrations_hash_key = "**********************************************"; # put your credentials here
						$list_id        = 'ID OF LIST CREATED IN SENDLANE ACCOUNT'; # put the List ID here

						$collect_leads_username = explode(" ", $collect_leads_username); // username which has to be sent to the list EX : andy ideologi
						$collect_leads_fname    = $collect_leads_username[0]; // andy
						$collect_leads_lname    = $collect_leads_username[1]; // ideologi
						$collect_leads_email    = 'andy.ideologi@gmail.com';  // email to be inserted to list
						...
						curl_setopt($ch, CURLOPT_URL,            "https://yourwebsitename.sendlane.com/api/v1/list-subscribers-add" );  // use url of your app / account created
						curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
						curl_setopt($ch, CURLOPT_POST,           true);
